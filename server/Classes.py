...
class Tank:
    ...
    def _bodyMove(self):
        ...
        if keys[pygame.K_w]: self.position_vector += self.body_direction_vector * self.forward_speed
        if keys[pygame.K_s]: self.position_vector -= self.body_direction_vector * self.backward_speed
